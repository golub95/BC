report 50101 "Adacta Fixed Asset - List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/Fixed Asset List_Default.rdl';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(ExternalNumberTextLbl; ExternalCPT)
            {

            }
            column(External_No_; "External No.")
            {
    ...
    var
        ...
        ExternalNumberTextLbl: TextConst ENU = 'External No.', HRV = 'Vanjski br.';
        ExternalCPT: Text;
}
